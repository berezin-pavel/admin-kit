...
import type { ShowcaseResolvedGroup } from "@/lib/showcase-groups"

export function ShowcaseGallery({ group }: { group: ShowcaseResolvedGroup }) {
  return (
    <section id={group.id} className="flex flex-col gap-10">
