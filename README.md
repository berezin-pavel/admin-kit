...
same destructive pair that a palette gradient gets. Only a validated
colour ever reaches the CSS. `appearanceThemes` ships five calm presets
built entirely out of such colours — Slate, Mist, Sage, Ivory, Dune —
and the menu's Theme row applies one wholesale. A page backdrop is the soft
