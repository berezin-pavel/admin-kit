...
export const gradientIntents: Record<GradientId, GradientIntent> = {
  ...
  scarlet: { name: "Scarlet", family: "monochrome", angle: DEFAULT_ANGLE, stops: ["#eb7e92", "#ff98ab", "#ffc3cc"], text: "dark" },
  ...
  ultramarine: { name: "Ultramarine", family: "monochrome", angle: DEFAULT_ANGLE, stops: ["#00242e", "#003f4f", "#00637b"], text: "light" },
  periwinkle: { name: "Periwinkle", family: "monochrome", angle: DEFAULT_ANGLE, stops: ["#63a4ff", "#92bfff", "#bfd9ff"], text: "dark" },
  "slate-blue": { name: "Slate Blue", family: "monochrome", angle: DEFAULT_ANGLE, stops: ["#100d7a", "#2538a1", "#4561cc"], text: "light" },
